        ...
        <form action="#" method="GET">
            <div class="search">
                <form action={{URL('student')}} method="GET">
                    ...
                    <a class="addStudentButton" href={{'student/add'}}>Add Student</a>
                </form>
            ...
            @foreach ($students as $student)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ URL('student/delete', $student->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this student') "  style="display:inline">
                        @csrf
                        @method('DELETE')
